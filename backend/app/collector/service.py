                ...
                signal_rows.append(
                    {
                        ...
                        "company_source": classification.company_source,
                        "company_confidence": classification.company_confidence,
                        "hiring_confidence": classification.hiring_confidence,
                        "role_match_score": classification.role_match_score,
        ...
        *,
        ...
        for row, classification in zip(deduped, classifications, strict=False):
            ...
            entry = {
                ...
                "company_source": classification.company_source,
                "hiring_confidence": round(classification.hiring_confidence, 4),
                "role_match_score": round(classification.role_match_score, 4),
